  ...
  return (
    <main className="flex-grow">
      ...
      <div className="container mx-auto flex justify-center gap-5 items-center flex-wrap text-white text-2xl">
        <Link
          href="/colleges/ccs"
          className="bg-gradient-to-r from-transparent to-red-600 via-red-500 w-1/3  rounded-3xl overflow-hidden h-56 grid place-items-center text-center border  shadow-md relative"
        >
